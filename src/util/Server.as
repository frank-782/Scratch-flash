...
public class Server implements IServer {
	...
	public function Server() {
		...
		try {
			...
			//if (urlOverrides) overrideURLs(util.JSON.decode(urlOverrides));
		} catch (e:*) {
		}
	}
	...
	protected function setDefaultURLs():void {
		URLs.assetPrefix = Scratch.app.loaderInfo.parameters['asset_server'];
		URLs.projectPrefix = Scratch.app.loaderInfo.parameters['project_server'];
	}
	...
	protected function callServer(url:String, data:*, mimeType:String, whenDone:Function = null,
		...
		function completeHandler(event:Event):void {
			...
			//Scratch.app.logMessage(LogLevel.INFO,loader.data)
	...
	public function getAsset(md5:String, whenDone:Function):URLLoader {
		...
		var url:String = URLs.assetPrefix + 'GetAsset?name=' + md5;
	...
	public function getMediaLibrary(libraryType:String, whenDone:Function):URLLoader {
		...
		var url:String = URLs.assetPrefix + libraryType + 'Library.json';
		return serverGet(url, whenDone);
	}
	...
	protected function downloadThumbnail(url:String, w:int, h:int, whenDone:Function):URLLoader {
		...
		function imageError(e:IOErrorEvent):void {
			Scratch.app.logMessage(LogLevel.WARNING, 'ServerOnline failed to decode image \n by'+ url);
		}
	...
	public function getThumbnail(idAndExt:String, w:int, h:int, whenDone:Function):URLLoader {
		...
		var url:String = URLs.assetPrefix + 'GetAsset?name=' + idAndExt;
	...
	public function getLanguageList(whenDone:Function):void {
		serverGet('http://localhost/scratch/locale/lang_list.txt', whenDone);
	}

	public function getPOFile(lang:String, whenDone:Function):void {
		serverGet('http://localhost/scratch/locale/' + lang + '.po', whenDone);
	}
	...
	public function setProjectThumbnail(param1:String, param2:ByteArray, param3:Function) : void
	{
		...
		if(!this.lastThumbMD5 || this.lastThumbMD5 != _loc4_)
		{
			...
			_loc5_ = "/project/thumbnail/" + param1 + "/set/";
	...
	public function setAsset(param1:String, param2:ByteArray, param3:Function) : void
      {
         var _loc4_:* = URLs.assetPrefix + "/UploadAsset.php?name=" + param1;
         ...
         this.callServer(_loc4_,param2,mime,param3);
      }

	public function getProjectSaveURL(param1:String) : String{
         return URLs.projectPrefix + "UploadProject.php?id="+ param1;
      }
