   ...
   public class URLUtil
   {
      ...
      private static function internalObjectToString(param1:Object, param2:String, param3:String, param4:Boolean) : String
      {
         ...
         for(_loc7_ in param1)
         {
            ...
            if(_loc8_ is String)
            {
               _loc5_ = _loc5_ + (_loc9_ + "=" + (!!param4?encodeURIComponent(_loc8_ as String):_loc8_));
            }
            ...
            {
               _loc5_ = _loc5_ + (_loc9_ + "=" + (!!_loc8_?"true":"false"));
            }
            else if(_loc8_ is Array)
            {
               _loc5_ = _loc5_ + internalArrayToString(_loc8_ as Array,param2,_loc9_,param4);
            }
            else
            {
               _loc5_ = _loc5_ + internalObjectToString(_loc8_,param2,_loc9_,param4);
            }
         }
         return _loc5_;
      }
      ...
      private static function internalArrayToString(param1:Array, param2:String, param3:String, param4:Boolean) : String
      {
         ...
         while(_loc8_ < _loc7_)
         {
            ...
            if(_loc9_ is String)
            {
               _loc5_ = _loc5_ + (_loc10_ + "=" + (!!param4?encodeURIComponent(_loc9_ as String):_loc9_));
            }
            else if(_loc9_ is Number)
            {
               ...
               _loc5_ = _loc5_ + (_loc10_ + "=" + _loc9_);
            }
            else if(_loc9_ is Boolean)
            {
               _loc5_ = _loc5_ + (_loc10_ + "=" + (!!_loc9_?"true":"false"));
            }
            else if(_loc9_ is Array)
            {
               _loc5_ = _loc5_ + internalArrayToString(_loc9_ as Array,param2,_loc10_,param4);
            }
            else
            {
               _loc5_ = _loc5_ + internalObjectToString(_loc9_,param2,_loc10_,param4);
            }
            _loc8_++;
         }
         return _loc5_;
