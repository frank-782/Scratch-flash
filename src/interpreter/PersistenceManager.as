package interpreter
{
   ...
   public class PersistenceManager extends EventDispatcher
   {
      ...
      public function connect(param1:String) : void
      {
         ...
         {
            this.app.jsSetProjectBanner(cloudInfo,true);
         }
         if(ExternalInterface.available)
         {
      ...
      private function onCloudDataData(param1:String) : void
      {
      ...
      private function verifyOwner(param1:Boolean = false) : Boolean
      {
         ...
         if(this.app.projectOwner == this.app.userName)
         {
            return true;
         }
         if(param1)
