...
public class TopBarPart extends UIPart {
	...
	public static function strings():Array {
		...
		return ['File', 'Edit', 'Tips', 'Duplicate', 'Delete', 'Grow', 'Shrink','Offline Editor','See project page' ,];
	}
	...
	private function addSaveStatus() : void
      {
         ...
         this.saveStatus.addEventListener(MouseEvent.MOUSE_DOWN,Scratch.app.saveStatusClicked);
      }
	...
	protected function fixLayout():void {
		...
		if (projectPageButton) {
			projectPageButton.x = nextX - projectPageButton.width;
			projectPageButton.y = h + 5;
			// Don't upload nextX: we overlap with other items. At most one set should show at a time.
		}
	...
	private function addProjectButton() : void
      {
         this.projectPageButton = new IconButton(Scratch.app.returnToProjectPage,this.makeFlipButtonImg(true),this.makeFlipButtonImg(false));
	...
	private function fixStatusLayout() : void
      {
         this.saveStatus.x = this.saveStatus.textWidth - 15;
         this.saveStatus.y = 6;
      }
