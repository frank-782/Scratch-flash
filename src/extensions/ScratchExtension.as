...
public class ScratchExtension {
	...
	public static function TextToSpeech():ScratchExtension {
		var result:ScratchExtension = new ScratchExtension(ExtensionManager.TextToSpeeck, 0);
		result.isInternal = true;
		result.javascriptURL = Scratch.app.server.getOfficialExtensionURL('TextToSpeech.js');
		result.thumbnailMD5 = 'TextToSpeech.png'
		result.tags = ['hardware']
		return result;
	}
}
